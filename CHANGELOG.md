...
## [0.29.1](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.29.0...0.29.1)

### Merged

- fixes incorrect bslib [`#84`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/84)

### Commits

- bump [`b9129d9`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/b9129d961fd25b6bf4a7c9d0cde9d25649c0ba0c)

## [0.29.0](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.28.4...0.29.0) - 2023-04-25

### Merged

- fix: crash on node class [`#83`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/83)

### Commits

- bump [`a1be59b`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/a1be59b86468e176b0933b99db663fcd59839b2a)
- fix: crash on ondeclass [`4012554`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/40125546d223ad1d50d2c813de7ba48f10c19303)

## [0.28.4](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.28.1...0.28.4) - 2023-03-20

### Merged

- fixes dot syntax not working with @sync [`#82`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/82)

### Commits

- bump [`e873a65`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/e873a658cd95afcef4cf72189508cf06f8f34a36)
- bump [`49244d2`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/49244d272ea00719d973c6debd0633d5a8927f16)
- fix for error message crash [`20744aa`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/20744aab09a3997eabb163a0078b3cdff92fbf8e)

## [0.28.1](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.27.0...0.28.1) - 2023-03-03

### Merged

- Fix/node task return fix [`#81`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/81)
- feat(nodetask): can indicate maxTaskRetries on a generated task, and … [`#80`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/80)

### Commits

- bump [`13e6d66`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/13e6d66db7dff44820314cb1b94ec29974455180)
- adds tests to catch transpilation issues in nodetasks [`b943a36`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/b943a36fdebed4f586394776fb989a1ab58f611b)
- adds library file to store large functions instead of injecting them into code [`001422d`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/001422d697c63451946e364a2600c65c63929361)
- feat(nodetask): can indicate maxTaskRetries on a generated task, and also implement _execute method, to allow extending generated code with template method pattern [`40bd9b6`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/40bd9b631df0a706d84c32c782064d269b66742e)
- fix(tasks): fixes problem in node task that resulted in duplicate finish callbacks. Also makes more streamlined [`d50d591`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/d50d59181bfec82ba273762479cdf83c42e58e70)

## [0.27.0](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.26.1...0.27.0) - 2023-02-22

### Merged

- feat(nodetask): can now simply return a value to propagate it [`#79`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/79)

### Commits

- bump [`393576d`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/393576d54b12caf0ccb351f9a73f2220366e647f)
- bump [`5fb7914`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/5fb79140137891d4e6fa81896392f2199478db0a)

## [0.26.1](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.26.0...0.26.1) - 2023-02-21

### Commits

- bump [`4f6de0c`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/4f6de0c09f151efb2db53d6c38a6dc4ff5369df9)
- patch for bad transpile [`aee6ee0`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/aee6ee0610ed8ea30583aba58d14331db80b5ce2)

## [0.26.0](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.25.7...0.26.0) - 2023-02-21

### Merged

- remove warning that's not needed [`#78`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/78)
- Adds support for injecting with default values and index dereferencin… [`#75`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/75)
- Fixes [`#76`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/76)
- Chore/upgrade bsc [`#73`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/73)
- Upgrade to bsc0.61.2, file api fixes [`#72`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/72)
- Fix tsc errors [`#71`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/71)

### Commits

- update to bsc 0.59.0 [`5785730`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/5785730759879f2a8d48d4a0baf5878db205d14e)
- wip [`e565b76`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/e565b7609cdcddbc420dac18fc465ac25cf25293)
- bump package log [`b453db8`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/b453db87e6105bfcc39d9ed0dd62c46024f995c1)
- Fix issues related to upgrading to bsc@0.61.2 [`6f10536`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/6f10536876012de8f5d0267f956dcc446f414c7e)
- Adds support for injecting with default values and index dereferencing in as expressions [`5dca51d`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/5dca51d2975b5d016e4ccedbfcc3bdaa31e20d5d)
- adds support for default enum values in node classes [`70b2b4e`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/70b2b4e89dfc6042dfb680cf6a93ea03de0e6b71)
- fixes nodeclass related issues [`de3a23c`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/de3a23c064c05cdef20e85c0af420052bb22169f)
- fixes issues that prevented m method validations working [`041b7c2`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/041b7c21e6861deaea62fd63267f614b4af40764)
- update package [`1d4b02e`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/1d4b02ede3070c0f05edfbba21ae6e3a1a92ff41)
- adds test for negative numbers on class fields [`4e7560e`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/4e7560ef77c25357ae358059ab3d9b9e6b26fd43)
- bsc update - test fix [`1af8cc0`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/1af8cc05e6de5ad7ae2fb1bcc9e22e3e63040e83)
- adds ability to transpile asNode to asAA for testing purposes [`2757ad8`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/2757ad84b547dd171db1e1c4baeb0e6886cd4dc2)
- try fix build [`b3187c3`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/b3187c347e136a130c562029492029b114a7820f)
- adds ability to transpile asNode to asAny for testing purposes, as that's better [`6c54ab2`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/6c54ab2f7598064e5056d2dd16b71a9904de7454)
- bump [`8c6e304`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/8c6e3043a99c3fb3541d99e61ae2cb90c5e45fe4)
- fixing ci [`10bef6c`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/10bef6c7a867afbd3e5efcd312ffb46c331b5c35)
- Fix broken test [`ddbaa8e`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/ddbaa8e0f3d0369d0d8d6243c0c474f5391fba34)
- fixes linting and tests [`1952005`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/1952005b15798f6e7877f3eac42b58d2521d94ae)
- fixes wrong warning [`289be99`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/289be9903f4c472de20721cae626dc4117740b83)
- try fix build [`c6be946`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/c6be946910f595547376bc1c4cdcbe86a7c04337)
- chore: removes some noisy logging [`7a4268f`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/7a4268f7e6abb70c2478f29907ed627b1f68f99b)
- removes logging [`7e370ee`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/7e370eed7027f0db9fd4b0cc9927885317fe3fe0)
- Fixing CI [`5b23757`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/5b237577824101ef9593478e9854f646286264f7)
- update package.json [`9a3aacd`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/9a3aacd17e226fa73d0a4a39b9a3798d5ea540c6)
- Fix back-compat issue [`1248505`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/1248505e2aeae5f788359aff8ed7b23a13d7640f)
- try fix build [`9576bb6`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/9576bb677d0042563f4e99e61ee5ab2692049bee)
- try fix build [`969a35b`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/969a35b380c290a63d2e12be07703f61489383af)
- bump node on github runner [`1b50bf4`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/1b50bf4dca390a8a4441aa96dffa8457b40c3fe6)
- fix error [`4940d2d`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/4940d2d212f4c34c1c89686db619e1fb7fae336c)
- try fix build [`958b6e8`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/958b6e8ac3b53070e72743302d9b5cb61cbbc0e0)
- removes logging [`c17a536`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/c17a536ad13e593f5775b7f0ebaa014ddca4fdd0)

## [0.25.7](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.25.5...0.25.7) - 2022-08-05

### Merged

- Fix/adds asnumber [`#64`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/64)
- Fix/include fields without public access modifiers as public on node classes [`#69`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/69)

### Commits

- fix: include default accessModifier members in getAllXXX util methods [`fb909b6`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/fb909b6b04b7367387050b40f53ca7961ce7d96d)
- bump [`cbf341a`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/cbf341acf95d656b43e6a889d6c072718d260592)
- bump [`83885ee`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/83885ee8f8e1a709ac79f7191e1493237129d8a8)
- Bump [`dd0963a`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/dd0963a0680b39ffdbd9547eaa3b8c71f3b18959)
- bump [`f01fe4b`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/f01fe4b0a59f1033aa06d8b08f7cb3a061c02447)
- --ammend [`840f9da`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/840f9da1a7f2b7d62cdf01bbb86ab7e7181827c2)
- adds support for asNumbergs [`3b24393`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/3b24393b838b37a9058ba249005f6d11e8e9c97f)

## [0.25.5](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.25.4...0.25.5) - 2022-08-01

## [0.25.4](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.25.3...0.25.4) - 2022-08-01
...
- feat(nodetask): adds suppport for auto-handling errors during execution [`#65`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/65)
...
## [0.23.1](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.23.0...0.23.1) - 2022-05-26
...
## [0.22.1](https://github.com/georgejecook/maestro-roku-bsc-plugin/compare/0.22.0...0.22.1) - 2022-05-23
...
- adds observe substitution [`#40`](https://github.com/georgejecook/maestro-roku-bsc-plugin/pull/40)
...
- practically fixed [`f33aa8d`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/f33aa8dd5db7344bce48da9b134ef61c6e97f647)
...
- feat(validation): adds extra validations for missing imports for class methods, classes, and namespaceS [`9fe1b6b`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/9fe1b6b88c3ed83671ae60e6d01e86bc9af607f9)
...
- version bump [`81275e7`](https://github.com/georgejecook/maestro-roku-bsc-plugin/commit/81275e77d1393cacbd2a3b7f437df32d12bd94ec)
